...
def match_hsr(tao):
    ...
    tao.cmd('set universe 16 on')
    tao.cmd('set universe 16 off')
    ...
    tao.cmd('set universe 10 on')
    tao.cmd('set universe 10 off')
    ...
    tao.cmd('set universe 12 on')
    tao.cmd('set universe 12 off')
    ...
    tao.cmd('set universe 13 on')
    tao.cmd('set universe 13 off')
    ...
    tao.cmd('set universe 17 on')
    tao.cmd('set universe 17 off')
