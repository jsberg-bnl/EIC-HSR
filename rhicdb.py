...
ins07y = line('y','yi7_int9_3','yi7_d0',db)
ins08y = line('y','yo8_d0','yo8_int9_3',db)
...
line_list = [
    ...
    mat03y,trp03y,trp04y,mat04y,ins07y,ins08y,ins09y,ins10b,ins10y,mat11b,trp11b,ins11y,trp12b,mat12b]
...
ir8_parts = [slot('y','dx07y',db),slot('y','dx08y',db)]
ir12_parts = [slot('b','bo11_du3',db),slot('b','g12_dux',db),slot('b','bi12_du3',db)]

slots_and_lines = line_info(line_list+ir2_slots+ir4_parts+ir6_slots+ir8_parts+ir10_slots+ir12_parts+ir12_slots) # Everything I have some need for
all_parts = line_info(ir2_slots+ir4_parts+ir6_slots+ir8_parts+ir10_slots+ir12_parts+ir12_slots) # Things I need all the parts for 
