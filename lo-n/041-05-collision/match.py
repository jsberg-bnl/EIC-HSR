...
def match_hsr(tao):
    ...
    tao.cmd(ir_var[5])
    tao.cmd('use dat ir2.kicker[2,4,5]')
    tao.cmd('use dat ir2.center[2,4,5]')
    tao.cmd('use dat ir2.cool[2,3]')
    tao.cmd('use dat ir2.aper[4]')
